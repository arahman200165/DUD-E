...
export const TOOL_DEFINITIONS: readonly ToolDefinition[] = [
  ...
  },
  {
    ...
    description: 'Convert between Unix timestamps (seconds through nanoseconds), ISO 8601, RFC 2822, and human-readable dates.',
    category: 'date-time',
    keywords: ['unix', 'timestamp', 'epoch', 'date', 'time', 'utc', 'convert', 'microseconds', 'nanoseconds', 'iso 8601', 'rfc 2822'],
